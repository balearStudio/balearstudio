 ...
 *  `slug` is the case-study being shown, or null on the home page. */
export function LanguageProvider({ lang = DEFAULT_LANG, slug = null, children }) {
  const value = useMemo(() => {
    ...
    return { lang, slug, t, languages: LANGUAGES }
  }, [lang, slug])
